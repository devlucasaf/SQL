/*
Exercício 02) Considerando o que você aprendeu sobre performance, resolva os exercícios abaixo

	- Traga os funcionários que trabalhem no departamento de filmes OU no departamento de roupas
	
	- O gestor de marketing pediu a lista das funcionárias que trabalhem no departamento
	...
	pois ele irá checar a segunda condição um número menor de vezes
...
-- Quantidade de funcionárias femininas 
...
-- Funcionárias que trabalham no setor de filmes ou lar
...
-- Funcionários do sexo masculino ou funcionários que trabalham no jardim
